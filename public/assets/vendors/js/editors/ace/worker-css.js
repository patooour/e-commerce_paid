...
var Validation = {
    ...
    validate: function(property, value){
        ...
        if (!spec) {
            if (name.indexOf("-") !== 0){    //plugin prefixed are ok
...
CSSLint.addRule({
    id: "compatible-plugin-prefixes",
    name: "Require compatible vendor prefixes",
    desc: "Include all compatible plugin prefixes to reach a wider range of users.",
    browsers: "All",
    init: function (parser, reporter) {
        var rule = this,
            compatiblePrefixes,
...
CSSLint.addRule({
    ...
    desc: "When using a plugin-prefixed gradient, make sure to use them all.",
    browsers: "All",
    init: function(parser, reporter){
        var rule = this,
            gradients;
        ...
        parser.addListener("endrule", function(event){
            ...
            if (missing.length && missing.length < 4){
                reporter.report("Missing plugin-prefixed CSS gradients for " + missing.join(", ") + ".", event.selectors[0].line, event.selectors[0].col, rule);
            }
...
CSSLint.addRule({
    ...
    desc: "Properties should be known (listed in CSS3 specification) or be a plugin-prefixed property.",
    browsers: "All",
    init: function(parser, reporter){
        var rule = this;
...
CSSLint.addRule({
    ...
    desc: "When using a plugin-prefixed property, make sure to include the standard one.",
    browsers: "All",
    init: function(parser, reporter){
        var rule = this,
            properties,
            ...
            for (i=0, len=needsStandard.length; i < len; i++){
                ...
                if (!properties[needed]){
                    ...
                    if (properties[needed][0].pos < properties[actual][0].pos){
                        reporter.report("Standard property '" + needed + "' should come after plugin-prefixed property '" + actual + "'.", properties[actual][0].name.line, properties[actual][0].name.col, rule);
                    }
                }
            }
...
var Worker = exports.Worker = function(sender) {
    ...
    this.setInfoRules(
      ...
      "import|outline-none|plugin-prefix"
    );
};
